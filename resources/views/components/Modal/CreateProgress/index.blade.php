<div class="modal fade" id="exampleModalprogress" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('board.store') }}" method="POST">
                    ...
                    <input type="hidden" name="progress" value="In Progress" placeholder="Enter Description" class="form-control w-full">
                    <div class="mb-2">
